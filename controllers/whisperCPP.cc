...
std::optional<std::string> whisperCPP::ParseModelId(
...
void whisperCPP::TranscriptionImpl(
    const HttpRequestPtr& req,
...
// TODO: Unimplemented
void whisperCPP::ModelStatus(
    const HttpRequestPtr& req,
    std::function<void(const HttpResponsePtr&)>&& callback) {
  return;
}

void whisperCPP::CreateTranscription(
    const HttpRequestPtr& req,
    std::function<void(const HttpResponsePtr&)>&& callback) {
  return TranscriptionImpl(req, std::move(callback), false);
}

void whisperCPP::CreateTranslation(
    const HttpRequestPtr& req,
    std::function<void(const HttpResponsePtr&)>&& callback) {
